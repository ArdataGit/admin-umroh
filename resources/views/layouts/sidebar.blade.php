...
<aside id="sidebar"
    ...
    x-data="{
        ...
        isActive(path) {
            ...
            // Exact match
            if (currentPath === path || '{{ $currentPath }}' === path.replace(/^\//, '')) {
                return true;
            }
            // Check if current path starts with menu path (for child routes)
            // e.g., /data-hotel/create should activate /data-hotel menu
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="{{ route('dashboard.index') }}">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="dark:hidden" src="/images/logo/insani-logo.webp" alt="Logo" width="150" height="40" />
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="hidden dark:block" src="/images/logo/insani-logo-dark.webp" alt="Logo" width="150"
                height="40" />
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
