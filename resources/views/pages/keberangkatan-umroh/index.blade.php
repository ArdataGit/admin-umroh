...
@section('content')
<x-common.page-breadcrumb pageTitle="Keberangkatan Umroh" :breadcrumbs="[
    ['label' => 'Keberangkatan Umroh', 'url' => '#']
]" />
...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12" x-data='{
      ...
      confirmDelete() {
        ...
        fetch(`/keberangkatan-umroh/${this.deleteTarget.id}`, {
          method: "DELETE",
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <div class="flex flex-col gap-4 border-b border-gray-200 px-6 py-4 dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-4">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Jadwal Keberangkatan</h3>
                    <a href="{{ route('keberangkatan-umroh.create') }}" class="rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600">
                        Tambah Jadwal
                    </a>
                </div>
                 <div class="relative">
                    ...
                    <tbody>
                        <template x-for="(item, index) in paginatedItems" :key="item.id">
                            <tr class="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <a :href="`/paket-umroh/${item.paket_umroh_id}`" class="font-medium text-blue-600 hover:text-blue-500 hover:underline" x-text="item.nama_keberangkatan"></a>
                                </td>
                                ...
                                <td class="px-6 py-4" x-text="item.paket_umroh?.maskapai?.nama_maskapai || '-'"></td>
                                <td class="px-6 py-4" x-text="item.paket_umroh?.rute_penerbangan || '-'"></td>
                                <td class="px-6 py-4" x-text="item.paket_umroh?.lokasi_keberangkatan || '-'"></td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a :href="`/customer-umroh/${item.id}`" class="inline-block text-blue-600 hover:text-blue-800 font-medium text-xs" title="Lihat Manifest">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        <a :href="`/keberangkatan-umroh/${item.id}`" class="text-gray-500 hover:text-gray-700" title="Lihat">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                              <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                              <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                            </svg>
                                        </a>
                                        <a :href="`/keberangkatan-umroh/${item.id}/edit`" class="text-blue-500 hover:text-blue-700" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                         ...
                         <tr x-show="paginatedItems.length === 0">
                            <td colspan="8" class="px-6 py-4 text-center text-gray-500">Belum ada data keberangkatan.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
