...
@section('content')
<x-common.page-breadcrumb pageTitle="Detail Keberangkatan" :breadcrumbs="[
...
<div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mb-8">
        <div>
         ...
         <div>
            <h4 class="text-sm font-semibold uppercase text-gray-500 mb-2">Paket Umroh</h4>
            <div class="text-gray-800 dark:text-white">
                <a href="#" class="text-blue-500 hover:underline">{{ $keberangkatan->paketUmroh->nama_paket }} ({{ $keberangkatan->paketUmroh->kode_paket }})</a>
            </div>
        </div>
    ...
    <div class="mt-8 flex justify-end gap-3">
        <a href="{{ route('keberangkatan-umroh.index') }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Kembali</a>
        <a href="{{ route('keberangkatan-umroh.edit', $keberangkatan->id) }}" class="rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-600">Edit Data</a>
    </div>
</div>
@endsection
