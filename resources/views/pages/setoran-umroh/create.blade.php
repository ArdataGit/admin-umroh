             ...
             <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <input type="date" name="tanggal_transaksi" value="{{ date('Y-m-d') }}" min="1900-01-01" max="9999-12-31" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm" required />
                </div>
                 <div>
