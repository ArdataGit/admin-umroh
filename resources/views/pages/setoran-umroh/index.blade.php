...
@section('content')
<x-common.page-breadcrumb pageTitle="Setoran Tabungan Umroh" :breadcrumbs="[
...
<div class="space-y-6">
    ...
    <div class="col-span-12" x-data='{
      transactions: @json($tabungan->transaksiTabunganUmrohs),
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <div class="flex flex-col gap-4 border-b border-gray-200 px-6 py-4 dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-4">
                    ...
                    @if($canCreate)
                    <a href="{{ route('setoran-umroh.create', $tabungan->id) }}" class="rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600">
                        Tambah Data
                    </a>
                    @endif
                </div>
