...
@section('content')
<x-common.page-breadcrumb pageTitle="Edit Keberangkatan Haji" :breadcrumbs="[
...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12" x-data="keberangkatanEdit()">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <h3 class="mb-6 text-xl font-semibold text-gray-800 dark:text-white">Edit Jadwal Keberangkatan Haji</h3>
    ...
    function keberangkatanEdit() {
        return {
            ...
            form: {
                ...
                paket_haji_id: {{ $keberangkatan->paket_haji_id }},
            ...
            submitForm() {
                fetch('{{ route('keberangkatan-haji.update', $keberangkatan->id) }}', {
                    method: 'PUT',
                    headers: {
