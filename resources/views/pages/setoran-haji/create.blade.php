...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Setoran Haji" :breadcrumbs="[
...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12">
        <form action="{{ route('setoran-haji.store', $tabungan->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
