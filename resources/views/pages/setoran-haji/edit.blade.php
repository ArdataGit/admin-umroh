...
@section('content')
<x-common.page-breadcrumb pageTitle="Edit Setoran Haji" :breadcrumbs="[
    ['label' => 'Data Tabungan Haji', 'url' => route('tabungan-haji')],
    ['label' => 'Detail Setoran', 'url' => route('setoran-haji.index', $tabungan->id)],
    ['label' => 'Edit', 'url' => '#']
]" />

<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12">
        <form action="{{ route('setoran-haji.update', $transaksi->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="mt-8 flex justify-end gap-3">
            <a href="{{ route('setoran-haji.index', $tabungan->id) }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Batal</a>
