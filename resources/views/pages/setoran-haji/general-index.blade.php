...
@section('content')
<x-common.page-breadcrumb pageTitle="Data Setoran Haji" :breadcrumbs="[
    ['label' => 'Data Setoran', 'url' => '#'],
    ['label' => 'Setoran Haji', 'url' => '#']
]" />
      ...
      get filteredTransactions() {
        ...
        return this.transactions.filter(t => {
          return t.kode_transaksi.toLowerCase().includes(query) ||
                 ...
                 (t.tabungan_haji?.jamaah?.nama_lengkap && t.tabungan_haji.jamaah.nama_lengkap.toLowerCase().includes(query)) ||
      ...
      get sortedTransactions() {
        ...
        return [...this.filteredTransactions].sort((a, b) => {
          ...
          if (this.sortField === "nama_jamaah") {
            aVal = a.tabungan_haji?.jamaah?.nama_lengkap || "";
            bVal = b.tabungan_haji?.jamaah?.nama_lengkap || "";
          }
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <div class="flex flex-col gap-4 border-b border-gray-200 px-6 py-4 dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('tabungan-haji') }}" class="rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600">
                            ...
                            <tr class="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        <span class="font-medium text-gray-800 dark:text-white" x-text="trx.tabungan_haji?.jamaah?.nama_lengkap || '-'"></span>
                                        <span class="text-xs text-gray-500" x-text="trx.tabungan_haji?.kode_tabungan || '-'"></span>
                                    </div>
                                </td>
