...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Data Karyawan" :breadcrumbs="[
    ['label' => 'Data Karyawan', 'url' => route('data-karyawan')]
]" />
    <div class="grid grid-cols-12 gap-4 md:gap-6">

        <div class="col-span-12">
            <x-common.component-card title="Form Tambah Karyawan">
                <form action="{{ route('data-karyawan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="kode_karyawan" value="{{ $kodeKaryawan }}" readonly
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Kode karyawan di-generate otomatis</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_karyawan" value="{{ old('nama_karyawan') }}" placeholder="Masukkan nama karyawan" required
                        ...
                        <div>
                            ...
                            <input type="email" name="email_karyawan" value="{{ old('email_karyawan') }}" placeholder="email@example.com" required
                        ...
                        <div>
                            ...
                            <input type="text" name="kabupaten_kota" value="{{ old('kabupaten_kota') }}" placeholder="Masukkan Kota/Kabupaten" required
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="jenis_kelamin" required
                                    ...
                                    <option value="Laki-laki" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Laki-laki
                                    </option>
                                    <option value="Perempuan" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Perempuan
                                    </option>
                                </select>
                    ...
                    <div>
                        ...
                        <textarea name="alamat_karyawan" placeholder="Masukkan alamat lengkap" rows="3" required
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('alamat_karyawan') border-red-500 @enderror">{{ old('alamat_karyawan') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="catatan_karyawan" placeholder="Masukkan catatan tambahan..." rows="3"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">{{ old('catatan_karyawan') }}</textarea>
                    </div>
