...
@section('content')
<x-common.page-breadcrumb pageTitle="Edit Pembayaran" :breadcrumbs="[
...
<div class="col-span-12">
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
        ...
        <form action="{{ route('pembayaran-umroh.update', $pembayaran->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $pembayaran->customerUmroh->jamaah->nama_jamaah }}" readonly class="w-full rounded-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-sm text-gray-500" />
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="pt-4 flex justify-end gap-3">
                        <a href="{{ route('pembayaran-umroh.index') }}" class="rounded-lg border border-gray-300 px-6 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800">
                            Batal
                        </a>
