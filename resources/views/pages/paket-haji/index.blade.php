  ...
  <div class="grid grid-cols-12 gap-4 md:gap-6">
    ...
    <div class="flex flex-col gap-2 px-5 mb-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('paket-haji.create') }}" class="rounded-lg bg-blue-500 px-4 py-2 text-sm text-white">Tambah Paket</a>
        </div>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800">
                            ...
                            <td class="px-4 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    <a :href="`/paket-haji/${paket.id}`" class="text-green-500 hover:text-green-700">View</a>
                                    <a :href="`/paket-haji/${paket.id}/edit`" class="text-blue-500 hover:text-blue-700">Edit</a>
