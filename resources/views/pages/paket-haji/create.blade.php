            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="status_paket" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                        <option value="active" {{ old('status_paket') == 'active' ? 'selected' : '' }}>Active</option>
                        <option value="completed" {{ old('status_paket') == 'completed' ? 'selected' : '' }}>Completed</option>
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <select name="maskapai_id" @change="maskapai_price = $el.options[$el.selectedIndex].dataset.price || 0; calculateHPP(1); calculateHPP(2)" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" required>
                        <option value="">Pilih Maskapai</option>
                        @foreach($maskapais as $maskapai)
                            <option value="{{ $maskapai->id }}" data-price="{{ $maskapai->harga_tiket }}" {{ old('maskapai_id') == $maskapai->id ? 'selected' : '' }}>{{ $maskapai->nama_maskapai }}</option>
                        @endforeach
                    </select>
                </div>
                 <div>
                    ...
                    <select name="rute_penerbangan" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
                        <option value="direct" {{ old('rute_penerbangan') == 'direct' ? 'selected' : '' }}>Direct</option>
                        <option value="transit" {{ old('rute_penerbangan') == 'transit' ? 'selected' : '' }}>Transit</option>
                    </select>
                </div>
                 <div>
