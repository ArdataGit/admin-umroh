...
@section('content')
<x-common.page-breadcrumb pageTitle="Laporan Keberangkatan Umroh" :breadcrumbs="[
    ['label' => 'Statistik', 'url' => '#'],
...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center gap-2 rounded-xl border border-gray-200 bg-white p-2 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
        <a href="{{ route('statistik.laporan-keberangkatan-umroh', ['range' => 'all']) }}" 
        ...
        <a href="{{ route('statistik.laporan-keberangkatan-umroh', ['range' => 'today']) }}" 
        ...
        <a href="{{ route('statistik.laporan-keberangkatan-umroh', ['range' => 'month']) }}" 
        ...
        <a href="{{ route('statistik.laporan-keberangkatan-umroh', ['range' => 'year']) }}" 
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
        <div class="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Daftar Keberangkatan Umroh (per Tanggal)</h3>
        </div>
            ...
            <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-800 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4">Tanggal Keberangkatan</th>
