...
@section('content')
<x-common.page-breadcrumb pageTitle="Laporan Penjualan Haji Berdasarkan Agen" :breadcrumbs="[
    ['label' => 'Statistik', 'url' => '#'],
    ['label' => 'Penjualan Haji (Agen)', 'url' => '#']
]" />
...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center gap-2 rounded-xl border border-gray-200 bg-white p-2 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
        <a href="{{ route('statistik.laporan-penjualan-haji', ['range' => 'all']) }}" 
        ...
        <a href="{{ route('statistik.laporan-penjualan-haji', ['range' => 'today']) }}" 
        ...
        <a href="{{ route('statistik.laporan-penjualan-haji', ['range' => 'month']) }}" 
        ...
        <a href="{{ route('statistik.laporan-penjualan-haji', ['range' => 'year']) }}" 
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
        <div class="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Peringkat Penjualan Agen (Haji)</h3>
        </div>
