...
@section('content')
<x-common.page-breadcrumb pageTitle="Laporan Penjualan Umroh Berdasarkan Agen" :breadcrumbs="[
    ['label' => 'Statistik', 'url' => '#'],
    ['label' => 'Penjualan Umroh (Agen)', 'url' => '#']
]" />
...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center gap-2 rounded-xl border border-gray-200 bg-white p-2 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
        <a href="{{ route('statistik.laporan-penjualan-umroh', ['range' => 'all']) }}" 
        ...
        <a href="{{ route('statistik.laporan-penjualan-umroh', ['range' => 'today']) }}" 
        ...
        <a href="{{ route('statistik.laporan-penjualan-umroh', ['range' => 'month']) }}" 
        ...
        <a href="{{ route('statistik.laporan-penjualan-umroh', ['range' => 'year']) }}" 
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
        <div class="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white">Peringkat Penjualan Agen (Umroh)</h3>
        </div>
            ...
            <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-800 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 text-center">Jumlah Penjualan</th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                            ...
                            <td class="px-6 py-4 text-center">
                                <span class="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
                                    {{ number_format($item->total_penjualan, 0, ',', '.') }} Penjualan
                                </span>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <span>Tidak ada data penjualan pada periode ini</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
