...
@section('content')
<x-common.page-breadcrumb pageTitle="Data Pengeluaran Haji" :breadcrumbs="[
    ['label' => 'Pengeluaran Haji', 'url' => '#']
]" />
    ...
    <div class="col-span-12" x-data='{
        ...
        get filteredItems() {
            ...
            return this.items.filter(item => {
                return (item.kode_pengeluaran && item.kode_pengeluaran.toLowerCase().includes(query)) ||
                       ...
                       (item.keberangkatan_haji && item.keberangkatan_haji.nama_keberangkatan && item.keberangkatan_haji.nama_keberangkatan.toLowerCase().includes(query));
            });
        },
        get sortedItems() {
        ...
        <div class="flex flex-col gap-2 px-5 mb-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div class="flex items-center gap-3">
                <a href="{{ route('pengeluaran-haji.create') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-600 focus:ring-4 focus:ring-blue-500/20 dark:focus:ring-blue-600/20">
                    ...
                    <tbody>
                          <template x-for="(item, index) in paginatedItems" :key="item.id">
                            <tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-4 py-4">
                                     <p class="text-gray-500 text-theme-sm dark:text-gray-400" x-text="item.keberangkatan_haji?.nama_keberangkatan || 'N/A'"></p>
                                </td>
