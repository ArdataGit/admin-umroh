    ...
    <div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <div class="flex flex-col gap-4 border-b border-gray-200 pb-4 dark:border-gray-700 sm:flex-row sm:items-center sm:justify-between">
                <h3 class="text-lg font-semibold text-gray-800 dark:text-white">List Pendaftaran</h3>
                <a href="{{ route('pendaftaran-umroh.create') }}" class="rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600">
                    + Tambah Pendaftaran
                </a>
            </div>
                 ...
                 <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400 whitespace-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">
                                <span class="block font-medium">{{ $item->keberangkatanUmroh->nama_keberangkatan }}</span>
                                <span class="text-xs text-gray-400">{{ $item->keberangkatanUmroh->kode_keberangkatan }}</span>
                            </td>
