...
@section('content')
<x-common.page-breadcrumb pageTitle="Edit Pendaftaran Umroh" :breadcrumbs="[
    ...
    function pendaftaranForm() {
        return {
            form: {
                ...
                // Manifest
                keberangkatan_umroh_id: '{{ $pendaftaran->keberangkatan_umroh_id }}',
            ...
            init() {
                 this.$nextTick(() => {
                    const select = document.querySelector('select[x-model="form.keberangkatan_umroh_id"]');
                 ...
                 // Initialize searchAgent fields
                 const existingAgent = this.agents.find(a => a.id == this.form.agent_id);
                 if (existingAgent) {
                     this.searchAgent = existingAgent.nama_agent;
                 }
            },
            ...
            handleFile(e, key) {
             ...
             submitForm() {
                ...
                fetch('{{ route('pendaftaran-umroh.update', $pendaftaran->id) }}', {
