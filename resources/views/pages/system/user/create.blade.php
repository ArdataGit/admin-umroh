...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah User Baru" :breadcrumbs="[
    ['label' => 'System', 'url' => '#'],
    ...
    <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="mt-1 text-xs text-gray-500">Maksimal 2MB. Format: JPG, JPEG, PNG.</p>
