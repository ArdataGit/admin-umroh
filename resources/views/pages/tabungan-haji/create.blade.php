...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                 ...
                 <div>
                    ...
                    <input type="date" name="tanggal_pendaftaran" value="{{ old('tanggal_pendaftaran') }}" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm" required />
                </div>
                 <div>
        ...
        <div class="mt-8 flex justify-end gap-3">
            <a href="{{ route('tabungan-haji') }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Batal</a>
