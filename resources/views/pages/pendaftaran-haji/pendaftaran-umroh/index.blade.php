...
@section('content')
<div class="max-w-5xl mx-auto space-y-6" x-data="pendaftaranTable()">
    <x-common.page-breadcrumb pageTitle="Data Pendaftaran Umroh" :breadcrumbs="[
        ['label' => 'Pendaftaran Umroh', 'url' => '#']
    ]" />
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            ...
            <div class="flex flex-col gap-4 mb-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <!-- Print -->
                    <a href="{{ route('pendaftaran-umroh.print') }}" target="_blank" class="inline-flex items-center justify-center gap-2 rounded-lg bg-gray-500 px-4 py-2.5 text-sm font-medium text-white shadow-theme-xs hover:bg-gray-600">
                    ...
                    <!-- Export -->
                    <a href="{{ route('pendaftaran-umroh.export') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-green-500 px-4 py-2.5 text-sm font-medium text-white shadow-theme-xs hover:bg-green-600">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Create -->
                    <a href="{{ route('pendaftaran-umroh.create') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-medium text-white shadow-theme-xs hover:bg-blue-600">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tbody>
                        <template x-for="(item, index) in paginatedItems" :key="item.id">
                            <tr class="border-b bg-white hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <span class="block font-medium" x-text="item.keberangkatan_umroh.nama_keberangkatan"></span>
                                    <span class="text-xs text-gray-400" x-text="item.keberangkatan_umroh.kode_keberangkatan"></span>
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        <a :href="`/pendaftaran-umroh/${item.id}`" class="text-gray-500 hover:text-gray-700" title="Lihat">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                            </svg>
                                        </a>
                                        <a :href="`/pendaftaran-umroh/${item.id}/edit`" class="text-gray-500 hover:text-green-600" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <!-- Pagination Controls -->
            <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700" x-show="totalPages > 1">
    ...
    function pendaftaranTable() {
        return {
            ...
            get filteredItems() {
                ...
                return this.items.filter(item => {
                    return (
                        ...
                        item.keberangkatan_umroh.nama_keberangkatan.toLowerCase().includes(lowerQuery)
                    );
                });
            },
            ...
            confirmDelete() {
                ...
                fetch(`/pendaftaran-umroh/${this.deleteId}`, {
                    method: 'DELETE',
                    headers: {
