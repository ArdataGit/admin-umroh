...
@section('content')
<x-common.page-breadcrumb pageTitle="Detail Pendaftaran" :breadcrumbs="[
    ['label' => 'Pendaftaran Umroh', 'url' => route('pendaftaran-umroh.index')],
    ['label' => 'Detail', 'url' => '#']
]" />
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            ...
            <div class="space-y-3">
                <div>
                    <p class="text-xs text-gray-500">Paket Umroh</p>
                    <p class="font-bold text-blue-600">{{ $pendaftaran->keberangkatanUmroh->paketUmroh->nama_paket ?? '-' }}</p>
                </div>
                <div>
                    <p class="text-xs text-gray-500">Jadwal Keberangkatan</p>
                    <p class="font-medium">{{ $pendaftaran->keberangkatanUmroh->nama_keberangkatan }}</p>
                    <p class="text-sm text-gray-600">{{ \Carbon\Carbon::parse($pendaftaran->keberangkatanUmroh->tanggal_keberangkatan)->format('d F Y') }}</p>
                </div>
                <div>
        ...
        <div class="flex gap-3">
            <a href="{{ route('pendaftaran-umroh.index') }}" class="w-full text-center rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">
                Kembali
            </a>
            <a href="{{ route('pendaftaran-umroh.edit', $pendaftaran->id) }}" class="w-full text-center rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700">
                Edit Data
            </a>
        </div>
