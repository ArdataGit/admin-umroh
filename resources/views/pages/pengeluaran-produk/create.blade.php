...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Pengeluaran Produk" :breadcrumbs="[
    ['label' => 'Pengeluaran Produk', 'url' => route('pengeluaran-produk.index')],
    ['label' => 'Tambah', 'url' => '#']
]" />

<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12" x-data="pengeluaranProduk()">
        <form @submit.prevent="submitForm">
        
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <h3 class="mb-6 text-xl font-semibold text-gray-800 dark:text-white">Form Pengeluaran Produk</h3>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mb-6">
                 ...
                 <div>
                    ...
                    <input type="date" x-model="form.tanggal_pengeluaran" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white" required />
                </div>
                 <div>
            ...
            <div class="mt-8 flex justify-end gap-3">
                ...
                <button type="submit" :disabled="form.details.length === 0" class="rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed">Simpan Pengeluaran</button>
            </div>
        </div>
        </form>
    </div>
...
<script>
    function pengeluaranProduk() {
        return {
            ...
            addProduct(produk) {
                ...
                if (existing) {
                    ...
                    this.form.details.push({
                        ...
                        harga_satuan: produk.harga_jual,   // Default to Harga Jual for Output
                        quantity: 1,
            ...
            submitForm() {
                fetch('{{ route('pengeluaran-produk.store') }}', {
                    method: 'POST',
                    headers: {
