    ...
    <form action="{{ route('data-kota.update', $kota->id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
                ...
                <input type="text" name="kode_kota" value="{{ old('kode_kota', $kota->kode_kota) }}" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('kode_kota') border-red-500 @enderror" required />
            ...
            <div>
                ...
                <input type="text" name="nama_kota" value="{{ old('nama_kota', $kota->nama_kota) }}" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('nama_kota') border-red-500 @enderror" required />
