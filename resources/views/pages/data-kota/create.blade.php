...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Data Kota" :breadcrumbs="[
    ['label' => 'Data Kota', 'url' => route('data-kota.index')],
    ['label' => 'Tambah', 'url' => '#']
]" />

<div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
    <form action="{{ route('data-kota.store') }}" method="POST">
        @csrf
        ...
        <div class="mt-8 flex items-center justify-end gap-3">
            ...
            <button type="submit" class="rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-700 transition">Simpan Data Kota</button>
        </div>
    </form>
</div>
@endsection
