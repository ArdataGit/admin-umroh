...
<body>
    ...
    <div class="content">
        <div class="header-title" style="margin-top: 0px;">INVOICE TRANSAKSI LAYANAN</div>
    ...
    <table class="main-table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <strong>{{ $detail->layanan->nama_layanan ?? '-' }}</strong><br>
                    {!! nl2br(e($detail->layanan->deskripsi_layanan ?? '')) !!}
                </td>
                <td style="text-align: center;">{{ $detail->layanan->kategori_layanan ?? '-' }}</td>
    ...
    <div class="clearfix">
        <div style="float: left; width: 50%;">
            @php $paidPayments = $transaksi->pembayaranLayanans; @endphp
