...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Pembayaran Layanan" :breadcrumbs="[
    ['label' => 'Pembayaran Layanan', 'url' => route('pembayaran-layanan.index')],
    ['label' => 'History', 'url' => route('pembayaran-layanan.show', $transaksi->id)],
    ['label' => 'Tambah', 'url' => '#']
]" />
...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12">
        <div class="rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            ...
            <form action="{{ route('pembayaran-layanan.store-payment', $transaksi->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                ...
                <div class="flex justify-end gap-3 border-t border-gray-100 pt-6 dark:border-gray-800">
                    <a href="{{ route('pembayaran-layanan.show', $transaksi->id) }}" class="rounded-lg border border-gray-300 bg-white px-6 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800">Batal</a>
