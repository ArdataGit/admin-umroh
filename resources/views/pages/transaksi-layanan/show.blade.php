...
@section('content')
<x-common.page-breadcrumb pageTitle="Detail Transaksi Layanan" :breadcrumbs="[
...
<div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            ...
            <tbody>
                ...
                <tr class="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                        ...
                        <p class="text-xs text-gray-500">{{ $item->layanan->kode_layanan }}</p>
                    </td>
    ...
    <div class="mt-8 flex justify-end gap-3">
        <a href="{{ route('transaksi-layanan.index') }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Kembali</a>
        <a href="{{ route('transaksi-layanan.edit', $transaksi->id) }}" class="rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-600">Edit Data</a>
    </div>
</div>
@endsection
