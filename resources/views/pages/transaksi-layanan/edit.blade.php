...
@section('content')
<x-common.page-breadcrumb pageTitle="Edit Transaksi Layanan" :breadcrumbs="[
    ['label' => 'Transaksi Layanan', 'url' => route('transaksi-layanan.index')],
    ['label' => 'Edit', 'url' => '#']
]" />

<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12" x-data="transaksiLayananEdit()">
        <form @submit.prevent="submitForm">
        
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <h3 class="mb-6 text-xl font-semibold text-gray-800 dark:text-white">Edit Transaksi Layanan</h3>
