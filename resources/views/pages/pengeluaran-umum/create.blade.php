...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Pengeluaran Umum" :breadcrumbs="[
    ['label' => 'Pengeluaran Umum', 'url' => route('pengeluaran-umum.index')],
    ['label' => 'Tambah', 'url' => '#']
]" />

<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12" x-data="{
        jenisPengeluaran: ['operasional', 'transportasi', 'karyawan', 'logistik', 'umum', 'lainya']
    }">
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <h3 class="mb-6 text-xl font-semibold text-gray-800 dark:text-white">Form Pengeluaran Umum</h3>
            
            <form action="{{ route('pengeluaran-umum.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_pengeluaran" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white" placeholder="Contoh: Pembelian ATK" required />
                ...
                <div class="mt-8 flex justify-end gap-3">
                    <a href="{{ route('pengeluaran-umum.index') }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Batal</a>
