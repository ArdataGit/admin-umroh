...
@section('content')
<x-common.page-breadcrumb pageTitle="Detail Surat Izin Cuti" :breadcrumbs="[
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <div class="border-b border-gray-100 px-6 py-5 dark:border-gray-800 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('surat-izin-cuti.edit', $surat->id) }}" class="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">Edit</a>
                    <a href="{{ route('surat-izin-cuti.print-pdf', $surat->id) }}" target="_blank" class="rounded-lg bg-gray-600 px-4 py-2 text-sm font-medium text-white hover:bg-gray-700">Print</a>
                    <a href="{{ route('surat-izin-cuti.index') }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">Kembali</a>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between border-b pb-2 dark:border-gray-800">
                            <span class="text-gray-500">Kantor Instansi:</span>
                            <span class="font-medium text-gray-800 dark:text-white">{{ $surat->kantor_instansi }}</span>
                        </div>
                    </div>

                    <div class="space-y-4">
                        <div class="flex justify-between border-b pb-2 dark:border-gray-800">
                            <span class="text-gray-500">NIK Instansi:</span>
                            <span class="font-medium text-gray-800 dark:text-white">{{ $surat->nik_instansi ?? '-' }}</span>
                        </div>
                        <div class="flex justify-between border-b pb-2 dark:border-gray-800">
                            <span class="text-gray-500">Jabatan:</span>
                            <span class="font-medium text-gray-800 dark:text-white">{{ $surat->jabatan_instansi }}</span>
                        </div>
                         <div class="flex justify-between border-b pb-2 dark:border-gray-800">
