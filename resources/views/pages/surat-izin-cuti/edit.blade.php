...
@section('content')
<x-common.page-breadcrumb pageTitle="Edit Surat Izin Cuti" :breadcrumbs="[
...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12">
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <h3 class="mb-6 text-xl font-semibold text-gray-800 dark:text-white">Form Edit Surat Izin Cuti</h3>
            
            <form action="{{ route('surat-izin-cuti.update', $surat->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kantor_instansi" value="{{ old('kantor_instansi', $surat->kantor_instansi) }}" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white" placeholder="Contoh: PT. Mencari Cinta Sejati" required />
                     ...
                     <div>
                        ...
                        <input type="text" name="nik_instansi" value="{{ old('nik_instansi', $surat->nik_instansi) }}" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white" placeholder="Optional" />
                    ...
                    <div>
                        ...
                        <input type="text" name="jabatan_instansi" value="{{ old('jabatan_instansi', $surat->jabatan_instansi) }}" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:border-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-900 dark:text-white" placeholder="Contoh: Staff HRD" required />
