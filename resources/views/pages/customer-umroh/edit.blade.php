...
@section('content')
<x-common.page-breadcrumb pageTitle="Edit Jamaah" :breadcrumbs="[
    ['label' => 'Manifest Jamaah', 'url' => route('customer-umroh.index', $keberangkatan->id)],
    ['label' => 'Edit Jamaah', 'url' => '#']
]" />
...
<div class="grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12" x-data="customerUmrohForm()">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
            <h3 class="mb-6 text-xl font-semibold text-gray-800 dark:text-white">Form Edit Jamaah</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Nama Keluarga -->
                 ...
                 <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">*Pembayaran dilakukan di menu Pembayaran Umroh</p>
                </div>
...
<script>
    function customerUmrohForm() {
        return {
            ...
            submitForm() {
                fetch('{{ route('customer-umroh.update', $customer->id) }}', {
                    method: 'PUT',
                    headers: {
