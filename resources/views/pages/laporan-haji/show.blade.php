...
@section('content')
<x-common.page-breadcrumb pageTitle="Detail Manifest Keberangkatan Haji" :breadcrumbs="[
    ['label' => 'Laporan Haji', 'url' => route('laporan-haji.index')],
    ['label' => 'Detail', 'url' => '#']
]" />
        ...
        <div class="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
             <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
                <div>
                     ...
                     <p class="font-semibold text-gray-800 dark:text-white">{{ $keberangkatan->paketHaji->nama_paket ?? '-' }}</p>
                </div>
                <div>
                ...
                <div>
                 ...
                 <div>
                     ...
                     <p class="font-semibold text-gray-800 dark:text-white">{{ $keberangkatan->customerHajis->count() }} Orang</p>
                </div>
             </div>
        </div>
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="max-w-full overflow-x-auto custom-scrollbar">
                <table class="w-full min-w-[1000px]">
                    ...
                    <tbody>
                        @forelse($keberangkatan->customerHajis as $customer)
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="px-6 py-8 text-center text-gray-500">
                                    Belum ada jamaah haji terdaftar pada keberangkatan ini.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
