...
@section('content')
<x-common.page-breadcrumb pageTitle="Detail Jamaah Haji Manifest" :breadcrumbs="[
    ['label' => 'Manifest Jamaah Haji', 'url' => route('customer-haji.index', $customer->keberangkatan_haji_id)],
    ['label' => 'Detail Jamaah Haji', 'url' => '#']
]" />
...
<div class="space-y-6">
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
                ...
                <h4 class="text-sm font-semibold uppercase text-gray-500 mb-2">Paket & Keberangkatan</h4>
                 <div class="space-y-2 text-sm text-gray-800 dark:text-white">
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium">{{ $customer->keberangkatanHaji->nama_keberangkatan }}</span>
                    </div>
                     <div class="flex justify-between">
        ...
        <div class="mt-8 flex justify-end gap-3">
            <a href="{{ route('customer-haji.index', $customer->keberangkatan_haji_id) }}" class="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50">Kembali</a>
            <a href="{{ route('customer-haji.edit', $customer->id) }}" class="rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-600">Edit Data</a>
        </div>
    </div>
</div>
@endsection
