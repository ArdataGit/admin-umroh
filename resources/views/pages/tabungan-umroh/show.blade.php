...
@section('content')
<x-common.page-breadcrumb pageTitle="Detail Tabungan Umroh" :breadcrumbs="[
...
<div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-gray-900">
    <div class="mb-6 flex items-center justify-between border-b border-gray-200 pb-4 dark:border-gray-700">
        <div>
             ...
             <p class="text-sm text-gray-500">Jamaah: {{ $tabungan->jamaah->nama_lengkap }}</p>
        </div>
       
        <div class="flex gap-2">
            <a href="{{ route('tabungan-umroh') }}" class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50">Kembali</a>
            <a href="{{ route('tabungan-umroh.edit', $tabungan->id) }}" class="inline-flex items-center justify-center rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white shadow-theme-xs hover:bg-blue-600">Edit</a>
        </div>
    </div>
            ...
            <div class="space-y-3">
                <div class="flex justify-between border-b border-gray-100 pb-2 dark:border-gray-800">
                 ...
                 <div class="flex justify-between border-b border-gray-100 pb-2 dark:border-gray-800">
                    ...
                    <span class="px-2 py-1 rounded text-xs font-semibold uppercase {{ $tabungan->status_tabungan == 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">{{ $tabungan->status_tabungan }}</span>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="space-y-3">
                <div class="flex justify-between border-b border-gray-100 pb-2 dark:border-gray-800">
                 ...
                 <div class="flex justify-between border-b border-gray-100 pb-2 dark:border-gray-800">
                    <span class="text-sm text-gray-500">Setoran Tabungan</span>
                 ...
                 @if($tabungan->catatan_pembayaran) 
                    <div class="mt-2 text-gray-600 dark:text-gray-400 border-t border-gray-100 pt-2"><span class="font-semibold block">Catatan:</span> {{ $tabungan->catatan_pembayaran }}</div>
                @endif
            </div>
        </div>
    </div>
