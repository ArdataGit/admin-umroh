                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800">
                            ...
                            <td class="px-4 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                     <a :href="`/tabungan-umroh/${tabungan.id}`" class="text-green-500 hover:text-green-700">View</a>
                                    <a :href="`/tabungan-umroh/${tabungan.id}/edit`" class="text-blue-500 hover:text-blue-700">Edit</a>
