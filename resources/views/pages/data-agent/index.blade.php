...
@section('content')
<x-common.page-breadcrumb pageTitle="Data Agent" />
  ...
  <div class="grid grid-cols-12 gap-4 md:gap-6">
    ...
    <div class="col-span-12" x-data='{
      ...
      confirmDelete() {
        ...
        fetch(`/data-agent/${this.deleteTarget.id}`, {
          method: "DELETE",
          headers: {
        ...
        .then(data => {
          if (data.success) {
            ...
            alert("Gagal menghapus data agent");
          }
        })
        .catch(error => {
    ...
    <div class="flex flex-col gap-2 px-5 mb-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('data-agent.create') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-500 px-4 py-2.5 text-sm font-medium text-white shadow-theme-xs hover:bg-blue-600">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tr class="border-b border-gray-100 dark:border-gray-800">
                        ...
                        <th class="px-4 py-3 text-left cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800" @click="sortBy('kode_agent')">
                            <div class="flex items-center gap-1">
                                <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Kode Agent</p>
                                <svg class="w-4 h-4" :class="sortField === 'kode_agent' && sortDirection === 'asc' ? 'text-blue-500' : 'text-gray-400'" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <th class="px-4 py-3 text-left cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800" @click="sortBy('nama_agent')">
                            <div class="flex items-center gap-1">
                                ...
                                <svg class="w-4 h-4" :class="sortField === 'nama_agent' && sortDirection === 'asc' ? 'text-blue-500' : 'text-gray-400'" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"/>
                                </svg>
                            </div>
                        </th>
                        ...
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <td class="px-4 py-4">
                                <span :class="agent.status_agent === 'Active' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'" class="inline-flex rounded-full px-2 py-1 text-xs font-medium">
                                    <span x-text="agent.status_agent"></span>
                                </span>
                            </td>
                            <td class="px-4 py-4">
