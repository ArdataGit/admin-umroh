    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12">
            <x-common.component-card title="Form Edit Hotel">
                <form action="{{ route('data-hotel.update', $hotel->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga_hotel" value="{{ old('harga_hotel', $hotel->harga_hotel) }}" placeholder="2500000" required min="0"
