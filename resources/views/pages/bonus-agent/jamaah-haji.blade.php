    ...
    <div class="col-span-12 space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <p class="text-sm text-gray-500 dark:text-gray-400">Total Jamaah Haji</p>
                    <p class="text-2xl font-bold text-purple-600">{{ $jamaahList->count() }} Pax</p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-800">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Daftar Jamaah Haji</h3>
            </div>
                        ...
                        @forelse($jamaahList as $index => $jamaah)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">
                                    {{ $jamaah->keberangkatanHaji->paketHaji->nama_paket ?? '-' }}
                                </td>
