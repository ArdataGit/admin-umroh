    ...
    <div class="grid grid-cols-12 gap-4 md:gap-6">
        ...
        <div class="col-span-12">
            <x-common.component-card title="Form Edit Maskapai">
                <form action="{{ route('data-maskapai.update', $maskapai->id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga_tiket" value="{{ old('harga_tiket', $maskapai->harga_tiket) }}" placeholder="15000000" required min="0"
