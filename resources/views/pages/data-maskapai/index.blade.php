                ...
                <tbody>
                    <template x-for="(maskapai, index) in paginatedMaskapais" :key="maskapai.id">
                        <tr class="border-b border-gray-100 dark:border-gray-800">
                            ...
                            <td class="px-4 py-4">
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90" x-text="formatPrice(maskapai.harga_tiket, maskapai.kurs, maskapai.kurs_asing)"></p>
                            </td>
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a :href="`/data-maskapai/${maskapai.id}`" class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300" title="View">
                                    ...
                                    @if($canEdit)
                                    <a :href="`/data-maskapai/${maskapai.id}/edit`" class="text-gray-500 hover:text-green-600 dark:text-gray-400 dark:hover:text-green-500" title="Edit">
                                    ...
                                    @endif
                                    @if($canDelete)
                                    <button @click="openDeleteModal(maskapai.id, maskapai.nama_maskapai)" class="text-gray-500 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-500" title="Delete">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
