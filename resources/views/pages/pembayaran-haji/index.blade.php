                                ...
                                <td class="px-4 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a :href="'{{ route('pembayaran-haji.detail', ':id') }}'.replace(':id', item.id)" class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300" title="Detail">
                                         ...
                                         <a :href="'{{ route('pembayaran-haji.print-pdf', ':id') }}'.replace(':id', item.id)" target="_blank" class="text-blue-500 hover:text-blue-700 dark:hover:text-blue-300" title="Print Invoice">
