...
return new class extends Migration
{
    ...
    {
        Schema::create('pengeluaran_hajis', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('jenis_pengeluaran'); // visa_haji, tiket_pesawat, etc.
    ...
    {
        Schema::dropIfExists('pengeluaran_hajis');
    }
};
