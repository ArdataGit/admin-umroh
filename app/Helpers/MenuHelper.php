...
class MenuHelper
{
    public static function getMenuTravel(){
        return [
            [
                'icon' => 'users-group',
                'name' => 'Data Pendaftar',
            ...
            [
                ...
                'name' => 'Data Laporan',
                'subItems' => [
                    ['name' => 'Laporan Umroh', 'path' => '/laporan-umroh'],
                    ['name' => 'Laporan Haji', 'path' => '/laporan-haji'],
                    ['name' => 'Laporan Keuangan', 'path' => '/laporan-keuangan'],
                    ['name' => 'Rugi Laba Penjualan', 'path' => '/rugi-laba-penjualan'],
                ]
            ],
            [
                'icon' => 'file-text',
    ...
    public static function getMenuLayanan(){
        return [
            [
                'icon' => 'users-group',
                'name' => 'Data Pelanggan',
    ...
    public static function getMenuGudang(){
        return [
            [
                'icon' => 'package',
                'name' => 'Data Produk',
    ...
    public static function getMenuGroups()
    {
        return [
            ...
            [
                'title' => 'Menu Travel',
                'items' => self::getMenuTravel()
            ],
            [
                'title' => 'Menu Layanan',
                'items' => self::getMenuLayanan()
            ],
            [
                'title' => 'Menu Gudang',
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'users-group' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.3333 13.3333C12.3333 13.3333 15.6667 13.3333 15.6667 16.6667M12.3333 13.3333C9.00002 13.3333 9.00002 16.6667 9.00002 16.6667M12.3333 13.3333C14.1743 13.3333 15.6667 11.841 15.6667 10C15.6667 8.15905 14.1743 6.66666 12.3333 6.66666C10.4924 6.66666 9.00002 8.15905 9.00002 10C9.00002 11.841 10.4924 13.3333 12.3333 13.3333Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M17.3333 16.6667C17.3333 16.6667 17.3333 14.1667 20.6666 14.1667M16.4999 7.50001C17.4204 7.50001 18.1666 8.2462 18.1666 9.16667C18.1666 10.0871 17.4204 10.8333 16.4999 10.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M7.33333 16.6667C7.33333 16.6667 7.33333 14.1667 4.00001 14.1667M8.16666 7.50001C7.24619 7.50001 6.5 8.2462 6.5 9.16667C6.5 10.0871 7.24619 10.8333 8.16666 10.8333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
            
            'briefcase' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 7V6C8 4.89543 8.89543 4 10 4H14C15.1046 4 16 4.89543 16 6V7M4 7H20V19C20 20.1046 19.1046 21 18 21H6C4.89543 21 4 20.1046 4 19V7Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
            
            'plane' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21L12 11M12 21L8 19M12 21L16 19M12 11L9.5 3.5L12 2L14.5 3.5L12 11ZM12 11L4 13L2.5 11.5L2 14.5L5.5 16L12 14ZM12 11L20 13L21.5 11.5L22 14.5L18.5 16L12 14Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
            
            'plane-departure' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.5 21H18.5M12 18L10.5 10.5L12.5 9L15.5 10.5L12 18ZM12 18L5.5 14L4.5 14.5L5 16.5L9.5 18L12 17ZM12 18L18.5 14L19.5 14.5L19 16.5L14.5 18L12 17Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>', // Using a simpler representation as placeholder if exact path not available, but let's try a better one
            
            'package' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 3L20 7.5V16.5L12 21L4 16.5V7.5L12 3Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 12L20 7.5M12 12V21M12 12L4 7.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'credit-card' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></rect><path d="M3 10H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'wallet' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 12V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V12ZM21 12H17C16.4477 12 16 12.4477 16 13C16 13.5523 16.4477 14 17 14H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'file-text' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M14 2V8H20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M16 13H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M16 17H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 9H8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'building' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 22V2H16V22M3 22H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M10 6H14M10 10H14M10 14H14M10 18H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'ticket' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10 21V19C10 18.4477 10.4477 18 11 18H13C13.5523 18 14 18.4477 14 19V21H21V16C20.4477 16 20 15.5523 20 15C20 14.4477 20.4477 14 21 14V10C20.4477 10 20 9.55228 20 9C20 8.44772 20.4477 8 21 8V3H14V5C14 5.55228 13.5523 6 13 6H11C10.4477 6 10 5.55228 10 5V3H3V8C3.55228 8 4 8.44772 4 9C4 9.55228 3.55228 10 3 10V14C3.55228 14 4 14.4477 4 15C4 15.5523 3.55228 16 3 16V21H10Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'piggy-bank' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M19.5 16C19.5 19.0376 17.0376 21.5 14 21.5C10.9624 21.5 8.5 19.0376 8.5 16C8.5 12.9624 10.9624 10.5 14 10.5C17.0376 10.5 19.5 12.9624 19.5 16Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M4 16C4 16 4.5 9 10 6.5C10 6.5 11 4.5 13 4.5C15 4.5 16.5 5 18 6.5C19.5 8 20.5 9 20.5 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'truck' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 3H16V16H1V3Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M16 8H20L23 11V16H16V8Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><circle cx="5.5" cy="18.5" r="2.5" stroke="currentColor" stroke-width="1.5"></circle><circle cx="18.5" cy="18.5" r="2.5" stroke="currentColor" stroke-width="1.5"></circle></svg>',

            'settings' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></circle><path d="M19.4 15A1.65 1.65 0 0021 12a1.65 1.65 0 00-1.6-3M16.6 5.4A1.65 1.65 0 0015 3a1.65 1.65 0 00-2.6 1.4M7.4 5.4A1.65 1.65 0 009 3a1.65 1.65 0 002.6 1.4M4.6 15A1.65 1.65 0 003 12a1.65 1.65 0 001.6-3M7.4 18.6A1.65 1.65 0 009 21a1.65 1.65 0 002.6-1.4M16.6 18.6A1.65 1.65 0 0015 21a1.65 1.65 0 00-2.6-1.4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'shield' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 22C12 22 20 18 20 12V5L12 2L4 5V12C4 18 12 22 12 22Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
            
            'grid-layers' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M2 12L12 17L22 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'shopping-cart' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 20C9 20.5523 8.55228 21 8 21C7.44772 21 7 20.5523 7 20C7 19.4477 7.44772 19 8 19C8.55228 19 9 19.4477 9 20Z" fill="currentColor"></path><path d="M20 20C20 20.5523 19.5523 21 19 21C18.4477 21 18 20.5523 18 20C18 19.4477 18.4477 19 19 19C19.5523 19 20 19.4477 20 20Z" fill="currentColor"></path><path d="M1 1H4L6.68 14.39C6.77144 14.8504 7.17197 15.1867 7.64 15.19H19.4C19.868 15.1867 20.2686 14.8504 20.36 14.39L23 6H6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
            
            'money-out' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2V14M12 14L8 10M12 14L16 10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 19H19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 15H3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M19 15H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'money-in' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 14V2M12 2L8 6M12 2L16 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 19H19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M5 15H3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M19 15H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
